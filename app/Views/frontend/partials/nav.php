...
<nav class="front-nav">
    ...
    <div class="menu-links">
        ...
        <a href="/lang/es" class="lang-link">
            <img src="/assets/img/flags/es.svg" class="flag-icon" alt="" aria-hidden="true" width="18" height="12">
            ES
        </a>
        <a href="/lang/en" class="lang-link">
            <img src="/assets/img/flags/gb.svg" class="flag-icon" alt="" aria-hidden="true" width="18" height="12">
            EN
        </a>
