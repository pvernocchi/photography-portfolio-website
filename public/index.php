...
$router->get('/private-gallery/{slug}', [FrontendController::class, 'privateCategory']);
$router->post('/private-gallery/{slug}/unlock', [FrontendController::class, 'unlockPrivateCategory']);
$router->get('/private-gallery/{slug}/download/{id}', [FrontendController::class, 'downloadPrivateOriginal']);
...
$router->group('/admin', [], static function (Router $router): void {
    ...
    $router->group('', ['auth', 'mfa'], static function (Router $router): void {
        ...
        $router->get('/images/duplicated', [ImageController::class, 'duplicated']);
